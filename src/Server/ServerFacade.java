...
public class ServerFacade implements IServer {
        ...
        try {
            ...
            if (DAO._SINGLETON.login(username, password))
            {
                ...
                else
                {
                    ...
                    {
                        if(theUser.getJoinedGames().get(0).get_i_gameId() == startedGames.get(i).get_i_gameId())
                        {
                            isStarted = true;
                            break;
                        }
    ...
    public CommandContainer addJoinableGame(Game game, String str_authentication_code) {
        ...
        try {
            ...
            theGame.addPlayerToGame(theUser.get_Username(), theUser);
            ...
            commandContainer.str_type.clear();
            commandContainer.str_type.add("AddWaitingCommand");
            
            commandContainer.icommand.clear();
            commandContainer.icommand.add(new AddWaitingToClientCommand(theGame));
