...
public class Route implements iRoute {
	public Route(int color, int weight, String owner, Pair<String, String> p, Point p1, Point p2, String sColor){
        _i_Color = color;
        _i_Weight = weight;
        _S_Owner = owner;
    ...
    public static void initAllRoutes() {
        ...
        Route r = new Route(color, weight, null, p, p1, p2, "RED");
        ...
        r = new Route(color, weight, null, p, p1, p2, "RED");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "WHITE");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "ORANGE");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "GREEN");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "BLUE");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "BLACK");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "YELLOW");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "PINK");
        _M_nameToRoute.put(mappingName, r);
        ...
        r = new Route(color, weight, null, p, p1, p2, "GRAY");
        _M_nameToRoute.put(mappingName, r);
